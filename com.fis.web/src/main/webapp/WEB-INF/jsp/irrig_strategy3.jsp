...
<body>
	...
	<div class="my-bg">
				...
				<div class="col-xs-11">
					<div style="background-color:#F8F8F6; border-radius: 4px;">
						...
						<ol class="breadcrumb irrig-bread-nav">
							<li><a>灌溉策略</a></li>
							<li class="active">小麦种植区</li>
						</ol>
					</div>
					<div class="irrig-info">
						<h3><strong>种植区视图</strong></h3>
						<hr style="margin-top:0px; border-top-width: 3px">
						<img alt="图片" src="${pageContext.request.contextPath}/image/003.jpg" width="100%" class="irrig-show-pic" value="0">
						...
						<div class="row">
							...
							<div class="col-md-6 col-sm-12">
								<div class="canvas-holder">
									...
									<p class="h5 text-center"><em>--采用机器学习算法训练灌溉预测和干旱等级判定模型,通过模型来给出灌溉方案!--</em></p>
		...
		<ul class="nav nav-pills nav-stacked irrig-nav">
			<li class="irrig-nav-1 text-center"><a href="${pageContext.request.contextPath}/page/irrig_strategy">玉米种植区</a></li>
			<li class="irrig-nav-2 text-center"><a href="${pageContext.request.contextPath}/page/irrig_strategy2">水稻种植区</a></li>
			<li class="active irrig-nav-3 text-center"><a href="">小麦种植区</a></li>
			<li class="irrig-nav-4 text-center"><a href="${pageContext.request.contextPath}/page/irrig_strategy4">大棚种植区</a></li>
		</ul>
	</div>
	...
	<script>
		...
		$.ajax({
		    ...
		    success:function(data,textStatus,jqXHR){
		    	...
		    	wind_power = parseInt(wind_power.split("级")[0]);
		    	ad1 = data.ad0;
		    	ad2 = data.ad1;
		    },
		...
		$('#irrig-pred-btn').click(function(){
			...
			if(global_user !== ""){ //已经登录则开始灌溉
				...
				$('.irrig-show-pic').attr('src', "${pageContext.request.contextPath}/image/003i.gif");
				$('.irrig-show-pic').attr('value', '1');
				setTimeout(function(){
					$('.irrig-show-pic').attr('src', "${pageContext.request.contextPath}/image/wheat3.jpg");
