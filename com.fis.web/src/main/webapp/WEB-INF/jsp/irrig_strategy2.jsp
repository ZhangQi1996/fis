...
<body>
	...
	<div class="my-bg">
				...
				<div class="col-xs-11">
					<div style="background-color:#F8F8F6; border-radius: 4px;">
						...
						<ol class="breadcrumb irrig-bread-nav">
							<li><a>灌溉策略</a></li>
							<li class="active">水稻种植区</li>
						</ol>
					</div>
					<div class="irrig-info">
						<h3><strong>种植区视图</strong></h3>
						<hr style="margin-top:0px; border-top-width: 3px">
						<img alt="图片" src="${pageContext.request.contextPath}/image/002.jpg" width="100%" class="irrig-show-pic" value="0">
		...
		<ul class="nav nav-pills nav-stacked irrig-nav">
			...
			<li class="active irrig-nav-2 text-center"><a href="">水稻种植区</a></li>
	...
	<script>
		...
		$('#irrig-pred-btn').click(function(){
			...
			if(global_user !== ""){ //已经登录则开始灌溉
				...
				$('.irrig-show-pic').attr('src', "${pageContext.request.contextPath}/image/002i.gif");
				$('.irrig-show-pic').attr('value', '1');
				setTimeout(function(){
					$('.irrig-show-pic').attr('src', "${pageContext.request.contextPath}/image/wheat2.jpg");
